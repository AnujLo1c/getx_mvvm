...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: ImageIcon(AssetImage(R.assets.menu)),
        title: Image(
          image: AssetImage(
            R.assets.logo,
          ),
        ...
        actions: [
          ...
          const Gap(2),
          ImageIcon(AssetImage(R.assets.scan), size: 18),
          const Gap(10)
        ],
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Gap(10),
            Image(image: AssetImage(R.assets.poster)),
            Gap(5),
            Row(
            ...
            SizedBox(
              ...
              child: GridView(
                ...
                children: [
                  categoryItem(
                      "assets/png/beauty.png", "Beauty", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/offers.png", "Offers", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/fashion.png", "Fashion", sp.withOpacity(0.2)),
                  categoryItem("assets/png/home_.png", "Home", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/shirt.png", "Shirt", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/bag.png", "Woman\n  Bag", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/dress.png", "Dress", sp.withOpacity(0.2)),
                  categoryItem(
                      "assets/png/mobile.png", "Moblies", sp.withOpacity(0.2)),
                ],
              ),
            ),
            Gap(20),
